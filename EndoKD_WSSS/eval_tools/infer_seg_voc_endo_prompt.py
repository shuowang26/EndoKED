...
from datasets import dataset_loader as voc
from datasets.dataset_loader import load_img_label_info_from_csv, load_test_img_mask
...
parser.add_argument("--model_path", default="/data/PROJECTS/Endo_GPT/EndoGPT_WSSS/work_dir_voc_wseg/2023-06-09-08-58-46-377065/checkpoints/model_iter_10000.pth", type=str, help="model_path")
...
def crf_proc(name_lst):
    ...
    images_path = '/data/Datasets/MedicalDatasets/息肉公开数据集/CVC-ClinicDB_datasets/CVC-ClinicDB_datasets/CVC-ClinicDB_PNG_datasets/Original/'
    labels_path = '/data/Datasets/MedicalDatasets/息肉公开数据集/CVC-ClinicDB_datasets/CVC-ClinicDB_datasets/CVC-ClinicDB_PNG_datasets/Ground Truth/'
    ...
    def _job(i):
        ...
        if "test" in args.infer_set:
            ...
            # label = np.asarray(Image.open(label_name).convert('L')) == 255
