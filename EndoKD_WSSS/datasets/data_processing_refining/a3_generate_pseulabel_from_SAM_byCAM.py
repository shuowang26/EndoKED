    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        with open (filtered_csv_path,'w') as f:
            ...
            for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
                ...
                name, inputs_, cls_label, image_raw, data_info = data
...
if __name__ == "__main__":
    ...
    filtered_csv_path = '/data/PROJECTS/Endo_GPT/EndoGPT_WSSS/datasets/a_zhongshan_2wpublic_all/filtered_after_CAM_zhongshan_2wpublic_imgPath.csv'
