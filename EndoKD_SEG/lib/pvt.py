import torch
import sys
sys.path.append('/data/PROJECTS/Endo_GPT/EndoGPT_WSSS/b_polyp_PVT')
...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        path = '/data/PROJECTS/Endo_GPT/reference_codes/Polyp-PVT-main/pretrained_pth/pvt_v2_b2.pth'
