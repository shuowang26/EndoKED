...
from utils.dataloader import test_dataset_polygen as test_dataset
...
if __name__ == '__main__':
    ...
    # for _data_name in ['polygen_all', 'polygen_videos_polyp_only']:
    ...
    for _data_name in dataset_lst:
        ...
        for i in tqdm(range(num1)):
            ...
            if target.sum() >= 1 and input.sum() >= 1:
