...
class PolypDataset(data.Dataset):
    ...
    """
    def __init__(self, args, image_root, gt_root, trainsize, augmentations):
...
def get_loader(args, image_root, gt_root, batchsize, trainsize, shuffle=True, num_workers=4, pin_memory=True, augmentation=False):

    dataset = PolypDataset(args, image_root, gt_root, trainsize, augmentation)
...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize, norm=True):
    ...
    def load_data(self):
        ...
        gt = np.array(self.binary_loader(self.gts[self.index]))
