...
if __name__ == '__main__':
    method_name = 'PIDNET-S'
    parser = argparse.ArgumentParser()
    parser.add_argument('--testsize', type=int, default=352, help='testing size')
    parser.add_argument('--pth_path', type=str, default='/data/PROJECTS/ENDOKD/Rebuttal/PIDNet/logs/Train_on_KvasirandDB/2024-05-19-16-17-51_scratch/PolypPVT-CASCADE5_best.pth')
    ...
    # for _data_name in ['polygen_videos_polyp_only']:
